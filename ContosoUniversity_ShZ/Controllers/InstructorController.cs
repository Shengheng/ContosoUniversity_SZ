    ...
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            if (courseID != null)
            {
                ...
                {
                    db.Entry(item).Reference(x => x.Student).Load();
                }
        ...
        public ActionResult Details(int? id)
        {
            ...
            var instructorDetails = db.Instructors.Find(id);
        ...
        private void PopulateAssignedCourseData(Instructor instructor)
        {
            ...
            //foreach instructor, list all courses, and mark the courses taughted by the instructor currently
